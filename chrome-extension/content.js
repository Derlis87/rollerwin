// RollerWin Capture v6.2 - Content Script (ISOLATED world, SOLO parent page)
// Crea la UI flotante y recibe numeros via postMessage y CustomEvent
// v6.2: Recovery ultra-rapido, deteccion cada 400ms, iframe reconnect
(function() {
  'use strict';
  ...
  function refreshStatus() {
    ...
    var lines = [];
    lines.push('MOTOR v6.2 | Capture v6.2');
  ...
  function createUI() {
    ...
    panel.innerHTML = '<div style="display:flex;align-items:center;gap:6px;margin-bottom:6px;">' +
      ...
      '<span style="font-size:11px;font-weight:600;color:#e4e4e7;">RollerWin Capture v6.2</span>' +
    ...
    statusEl.textContent = 'MOTOR v6.2 | Capture v6.2\n' +
  ...
  console.log('[RollerWin] Content Script v6.2 activo [PARENT]', location.hostname);
})();
