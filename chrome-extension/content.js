// RollerWin Capture v5.0 - Content Script (ISOLATED world, SOLO parent page)
// Crea la UI flotante y recibe numeros via postMessage y CustomEvent
// v5.0: DOM Scanner ultra-estricto + buffer anti-historial
(function() {
  'use strict';
  ...
  function refreshStatus() {
    ...
    var lines = [];
    lines.push('MOTOR v6.0 | Anti-hist v5.0');
  ...
  function createUI() {
    ...
    panel.innerHTML = '<div style="display:flex;align-items:center;gap:6px;margin-bottom:6px;">' +
      ...
      '<span style="font-size:11px;font-weight:600;color:#e4e4e7;">RollerWin Capture v5.0</span>' +
    ...
    statusEl.textContent = 'MOTOR v6.0 | Anti-hist v5.0\n' +
  ...
  console.log('[RollerWin] Content Script v5.0 activo [PARENT]', location.hostname);
})();
