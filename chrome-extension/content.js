// RollerWin Capture v7.6.3 - Content Script (ISOLATED world, SOLO parent page)
...
(function() {
  ...
  function refreshStatus() {
    ...
    var lines = [];
    lines.push('Motor v7.6.3 | Capture v7.6.3');
  ...
  function createUI() {
    ...
    panel.innerHTML = '<div style="display:flex;align-items:center;gap:6px;margin-bottom:6px;">' +
      ...
      '<span style="font-size:11px;font-weight:600;color:#e4e4e7;">RollerWin Capture v7.6.3</span>' +
    ...
    statusEl.textContent = 'Motor v7.6.3 | Capture v7.6.3\n' +
  ...
  console.log('[RollerWin] Content Script v7.6.3 activo [PARENT]', location.hostname);
})();
