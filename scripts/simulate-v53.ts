/**
 * Simulador v5.3 — Prueba el motor de predicción spin-by-spin
 * 
 * NOVEDADES v5.3:
 * - Tracking de racha máxima de pérdidas consecutivas
 * - Distribución de rachas de pérdida (cuántas de 1, 2, 3, 4, 5+)
 * - Martingala mejorada: cuenta resets por pico >3
 * - Recovery flip tracking
 * 
 * Uso: npx tsx scripts/simulate-v53.ts <archivo_con_secuencia.txt>
 */
...
function printResults(result: SimResult) {
  console.log('\n' + '═'.repeat(65))
  console.log('  SIMULACIÓN SMART PREDICTION v5.3')
