...
// v10.0: Basado en v7.6 probado, UI actualizada
(function() {
  'use strict';
  ...
  function refreshStatus() {
    ...
    var lines = [];
    lines.push('Motor v10.0 | ' + _casinoName);
    ...
    // Cambiar color del dot segun estado
    if (dotEl) {
      if (_kaStatus.recovering) {
  ...
  // 2. CustomEvent desde MAIN world en parent (numeros)
  ...
  function createUI() {
    ...
    statusEl.textContent = 'Motor v10.0 (v7.6 core)\n' +
  ...
  console.log('[RollerWin] Content Script v10.0 activo [PARENT]', location.hostname);
})();