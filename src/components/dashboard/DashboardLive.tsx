...
export function DashboardLive() {
  ...
  // ============================================
  // SISTEMA DE PREDICCIÓN AVANZADO v4.2 Anti-Streak Reloaded
  ...
  const generateSmartPrediction = useCallback((nums: number[], betType: BetType): SmartPrediction => {
    // Delegate to v4.2 engine (pure function, no React deps needed)
    ...
    return (
      <div className="fixed bottom-4 right-4 z-50 w-80 bg-zinc-900/95 backdrop-blur-sm border border-zinc-700 rounded-xl shadow-2xl overflow-hidden">
        ...
        {currentPrediction && numbers.length >= 5 && (
          <div className="p-3 border-b border-zinc-700">
            <div className="text-xs text-zinc-400 mb-2">🎯 Predicción IA v4.2:</div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg md:text-xl font-bold">
                ...
                <span className="text-[9px] bg-purple-500/20 text-purple-400 px-1.5 py-0.5 rounded font-mono">v4.2</span>
              </h1>
            </div>
                  ...
                  <Card className="bg-gradient-to-r from-zinc-900 to-zinc-800 border-amber-500/30">
                    <CardContent className="py-4 space-y-3">
                      <div className="flex items-center justify-between flex-wrap gap-4">
                        <div>
                          <div className="text-xs text-zinc-400 mb-1 flex items-center gap-2"><Target className="w-3 h-3" />PREDICCIÓN IA v4.2</div>
